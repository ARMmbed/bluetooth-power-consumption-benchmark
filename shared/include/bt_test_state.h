...
inline void print_bt_test_state(bt_test_state_t state, void(* print)(void*, const char *), void* arg)
{
    switch (state) {
#define BT_STATE_SWITCH_CASE(NAME) case bt_test_state_t::NAME: print(arg, #NAME); break;
